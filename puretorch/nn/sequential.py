...
class Sequential(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        """
        Performs a forward pass on the input Tensor and
        returns a Tensor with the output of the model
        Args:
    ...
    # def parameters(self):
    #    """
    #    Runs through each layer in the Sequential instance and
    #    gets the parameters from each layer and returns a list
    #    with the parameters of the model.

    #    NOTE: if you are using custom layers, you need to add
    #          your own `.parameters()` function to your layer.
    #          Make sure to return a list of parameters Returns:
    ...
    def __repr__(self) -> str:
        out: str = f"Sequential(name={self.name}, "\
