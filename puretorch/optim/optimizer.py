...
class Optimizer:
    ...
    def zero_grad(self, set_to_none: bool = False):
        ...
        Args:
            set_to_none (bool): sets the grads to None if True
                                or grad is zeros-like data
        """
    ...
    def step(self):
        """
        Performs a single optimization step on
        all given params (updates the parameters).
